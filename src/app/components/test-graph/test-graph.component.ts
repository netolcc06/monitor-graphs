...
export class TestGraphComponent implements OnChanges {
  ...
  constructor(private dataService:DataService){
    console.log(this.dataService.getData('http://localhost:8000/reports/compare/FPArith'));
  }
  ...
  ngOnChanges() {
    this.isLoading = true;
    this.dataService.getData(`http://localhost:8000/reports/${this.report}/` + this.logic)
